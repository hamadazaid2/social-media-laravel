                                    ...
                                    <div>
                                        ...
                                        <div class="flex items-center space-x-2">
                                            ...
                                            @if(Auth::user()->id !== $post->user->id)
                                                ...
                                                <form action="{{ route('followers.custom_destroy', ['follower_user_id' => $post->user->id]) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    <input type="hidden" name="follower_user_id" value="{{ $post->user->id }}">
                                                    <button type="submit"
                                                ...
                                                @else
                                                    <form action="{{ route('followers.store', ['follower_user_id' => $post->user->id]) }}" method="POST">
                                                        @csrf
                                                        <button type="submit"
