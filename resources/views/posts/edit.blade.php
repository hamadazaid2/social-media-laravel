                        ...
                        <form method="post" action="{{ route('posts.update', $post) }}" class="mt-6 space-y-6">
                            ...
                            <div>
                                ...
                                <textarea name="content" rows="10" cols="50"
                                    class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm w-full h-48 resize-none">{{ $post->content }}</textarea>
                                <div class="mb-4">
                                    <label for="category"
                                    ...
                                    <select name="category_id" id="category"
                                        ...
                                        <option value="{{ $category->id }}"
                                            selected='{{ $post->category_lookup_id === $category->id ?? selected }}'>
